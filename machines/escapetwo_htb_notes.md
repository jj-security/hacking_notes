...
smbclient found shares using the username rose and password provided:
```bash
...
smbclient found spreadsheets with usernames and passwords
```
└─$ smbclient \\\\$target\\Accounting\ Department -U rose 
...
smb: \> ls
  ...
  accounts.xlsx                       A     6780  Sun Jun  9 06:52:07 2024
		...
		6367231 blocks of size 4096. 714028 blocks available
smb: \> get accounts.xlsx
getting file \accounts.xlsx of size 6780 as accounts.xlsx (9.0 KiloBytes/sec) (average 9.0 KiloBytes/sec)
smb: \> get accounting_2024.xlsx 
getting file \accounting_2024.xlsx of size 10217 as accounting_2024.xlsx (13.0 KiloBytes/sec) (average 11.0 KiloBytes/sec)
